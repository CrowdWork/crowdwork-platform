...
function login_header( $title = 'Log In', $message = '', $wp_error = null ) {
	...
	$login_title = sprintf( __( '%1$s &lsaquo; %2$s &#8212; CrowdWork Co-op' ), $title, $login_title );
	...
	if ( is_multisite() ) {
		...
		$login_header_url   = __( 'https://crowdwork.io/' );
		$login_header_title = __( 'Powered by CrowdWork' );
	}
...
case 'register' :
	if ( is_multisite() ) {
		 ...
		 */
		wp_redirect( apply_filters( 'wp_signup_location', network_site_url( 'wp-login.php' ) ) );
		exit;
	}
